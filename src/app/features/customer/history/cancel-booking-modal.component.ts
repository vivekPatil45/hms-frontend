...
export class CancelBookingModalComponent implements OnInit {
    ...
    ngOnChanges(changes: any) {
        if (changes.isOpen && changes.isOpen.currentValue === true && this.reservation) {
            this.checkCancellationPolicy();
        }
    }
    ...
    checkCancellationPolicy() {
        ...
        this.bookingService.checkCancellation(this.reservation.reservationId).subscribe({
            next: (res) => {
    ...
    confirmCancellation() {
        ...
        this.bookingService.cancelReservation(this.reservation.reservationId).subscribe({
            next: () => {
