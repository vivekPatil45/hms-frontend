      ...
      <div class="hidden lg:flex lg:w-1/2 bg-hotel-navy text-white p-12 flex-col justify-between relative overflow-hidden">
        ...
        <div class="relative z-10">
          ...
          <div class="flex items-center gap-3 mb-12">
            ...
            <span class="text-2xl font-bold">Grand<span class="text-hotel-gold">Hotel</span></span>
          </div>

          <!-- Welcome Text -->
          <div class="space-y-4">
            <h1 class="text-4xl font-bold leading-tight">Welcome to Luxury</h1>
          ...
          <div class="mt-12 space-y-4">
            <div class="flex items-center gap-3">
              ...
              <span class="text-gray-300">24/7 Concierge Service</span>
            </div>
            <div class="flex items-center gap-3">
              <div class="h-2 w-2 rounded-full bg-hotel-gold"></div>
              <span class="text-gray-300">Luxury Room Selection</span>
            </div>
            <div class="flex items-center gap-3">
              <div class="h-2 w-2 rounded-full bg-hotel-gold"></div>
              <span class="text-gray-300">World-Class Dining</span>
            </div>
            <div class="flex items-center gap-3">
              <div class="h-2 w-2 rounded-full bg-hotel-gold"></div>
              <span class="text-gray-300">Premium Spa & Wellness</span>
            </div>
          </div>
        </div>
